...
##### TikTok is working on a machine learning model that will catergories videos based on claims and opinions. In this project the data is cleaned, structured analyzed and explored for better understanding. 
